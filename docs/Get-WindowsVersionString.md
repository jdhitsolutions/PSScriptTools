...
[-ThrottleLimit <Int32>] [-Authentication <String>] [-UseStyle] [<CommonParameters>]
```
...
If you are querying the local computer, all other parameters except UseStyle will be ignored.
...
Display the Windows version string using ANSI styles. The style colors are hard-coded.
